...
function FarmingPartySettings:SetWindowValues()
  ...
  local decoration = (fontSize <= 12 and 'soft-shadow-thin' or 'soft-shadow-thick')
...
function FarmingPartySettings:TogLootWin()
  if self.settings.displayOnWindow == true then
	self.settings.displayOnWindow = false
	self:SetWindowValues()
  else
	self.settings.displayOnWindow = true
    self:SetWindowValues()
  end
end
